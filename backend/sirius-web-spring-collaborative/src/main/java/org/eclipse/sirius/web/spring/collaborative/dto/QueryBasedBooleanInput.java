 ...
 * @author fbarbin
 */
public final class QueryBasedBooleanInput implements IInput {
    ...
    public QueryBasedBooleanInput() {
        // Used by Jackson
    }

    public QueryBasedBooleanInput(UUID id, String query) {
        this.id = Objects.requireNonNull(id);
        this.query = Objects.requireNonNull(query);
    }

    public QueryBasedBooleanInput(UUID id, String query, Object context) {
        this(id, query);
