...
/**
 * The data fetcher used to create a new element.
 *
 * @author Jerome Gout
 */
...
public class MutationCreateElementDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationCreateElementDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, CreateElementInput.class);
