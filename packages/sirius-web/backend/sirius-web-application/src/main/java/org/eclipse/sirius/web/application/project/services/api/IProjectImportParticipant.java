...
public interface IProjectImportParticipant {

    boolean canHandle(IDomainEvent event, IProjectImportContent projectUpdateContent);

    void handle(IDomainEvent event, IProjectImportContent projectUpdateContent);
}
